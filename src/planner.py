...
def generate_production_plan(
    ...
    # 7) Фиксированные ширины колонок по образцу
    ...
    with get_connection(db_path) as conn2:
        _generate_stage_sheets(conn2, wb, roots_df, start_date)
        _generate_settings_sheet(conn2, wb)
...
def _generate_stage_sheets(conn, wb: Workbook, roots_df, stocks_date: dt.date) -> None:
    """
...
def _generate_settings_sheet(conn, wb: Workbook) -> None:
    """
