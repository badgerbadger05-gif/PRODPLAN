...
class PaintWeldChainLink(Base):
    """
    Локальная связь заказов цепочки «окраска ↔ сварка».

    Сварная деталь входит в состав окрашенной, поэтому в 1С родителем является
    окрасочный заказ: сварочный документ несёт штатное окрасочное основание
