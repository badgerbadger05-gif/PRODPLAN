...
| Документ | Основание |
|---|---|
| `Document_ЗаказНаПроизводство` | из MRP — первичный, без основания; в цепочке «сварка→окраска» сварочный заказ создаётся первым без основания, окрасочный — на основании сварочного: `ЗаказНаПроизводствоОснование_Key` (Edm.Guid, специализированное поле) + `ДокументОснование`/`_Type` |
