...
> **Нормативный инвариант:** см.
> [`planning-truth-contract.md`](planning-truth-contract.md). Только принятое
> поколение Item Ledger является источником фактических остатков, движений,
> исполнения и реализации резервов. Legacy-агрегаты служат лишь сверке.
> Пустой/stale Ledger означает «данные недоступны» и блокирует зависимые
> расчёты и мутации; fallback и подмена нулём запрещены.
