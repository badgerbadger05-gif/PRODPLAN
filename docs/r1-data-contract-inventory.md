...
| supplier/future/export tables (`ledger_future_supply`, `purchase_export_line_allocation`, `purchase_export_batch.ledger_generation_id`, `purchase_export_batch.current_execution_scope_id`, `purchase_export_obligation_allocation`, `sync_link`) | evidence/export idempotency | capture/materialization/one_c exporters | export retry/read-back, purchase journals |
