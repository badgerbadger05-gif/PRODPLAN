                ...
                {!selected && (
                  <>
                    ...
                    <div className="detailGrid">
                      ...
                      <span>Готовых на складах</span><strong>{qty(result.root.stock_qty)} {result.root.unit || ''}</strong>
                ...
                {selected && (
                  <>
                    ...
                    <div className="detailGrid">
                      ...
                      <span>На складах</span><strong>{qty(selected.stock_qty)} {selected.unit || ''}</strong>
